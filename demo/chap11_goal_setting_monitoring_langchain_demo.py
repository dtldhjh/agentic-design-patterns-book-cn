...
llm = ChatOpenAI(api_key=OPENAI_API_KEY, # 请替换成您的ModelScope Access Token
    base_url="https://api-inference.modelscope.cn/v1/",
    model = "ZhipuAI/GLM-4.5",
    temperature=0.3)
llm_reviewer = ChatOpenAI(api_key=OPENAI_API_KEY, # 请替换成您的ModelScope Access Token
    base_url="https://api-inference.modelscope.cn/v1/",
...
{code}
"""
   return llm_reviewer.invoke(feedback_prompt)
